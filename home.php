        ...
        <div class="wrapper">
            ...
            <article class="column-2">
                <div class="maxheight indent-bot">
                    ...
                    <p class="p2">This <a href="http://blog.templatemonster.com/2012/01/23/free-website-template-jquery-slider-food-delivery-project/" target="_blank" rel="nofollow">Catering Template</a> goes with two packages – with PSD source files and without them. PSD source files are available for free for the registered members of TemplatesMonster.com. The basic package (without PSD source) is available for anyone without registration.</p>
                    This website template has several pages: <a href="index.php">About</a>, <a href="menu.php">Menu</a>, <a href="catalogue.php">Catalogue</a>, <a href="shipping.php">Shipping</a>, <a href="faq.php">FAQ</a>, <a href="contact.php">Contact</a> (note that contact us form – doesn’t work).
                </div>
